...
namespace TechXpress.Data.Migrations
{
    ...
    [Migration("20250505044011_updateOrderNumberLength")]
    partial class updateOrderNumberLength
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("TechXpress.Data.Models.AddressViewModel", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("TechXpress.Data.Models.ApplicationUser", null)
                        .WithMany()
            ...
            modelBuilder.Entity("TechXpress.Data.Models.CartItem", b =>
                {
                    b.HasOne("TechXpress.Data.Models.ProductViewModel", "Product")
                        .WithMany("CartItems")
            ...
            modelBuilder.Entity("TechXpress.Data.Models.Category", b =>
                {
                    b.HasOne("TechXpress.Data.Models.Category", "ParentCategory")
            ...
            modelBuilder.Entity("TechXpress.Data.Models.Order", b =>
                {
                    b.HasOne("TechXpress.Data.Models.AddressViewModel", "ShippingAddress")
                        .WithMany()
